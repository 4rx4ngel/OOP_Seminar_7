...
public class CalculatorService implements ICalculatorService {
    ...
    /**
     * формула для умножения комплексных чисел (a+bi)*(c+di) = (ac-bd) + (ad+bc)i
     */
    @Override
    public void mul() {
        double realPart = (complexNumberCalculator.getNumber1().getReal() *
    ...
    /**
     * формула для деления комплексных чисел (a+bi)/(c+di) = (ac+bd)/(с^2+d^2) + (bc-ad)/(с^2+d^2)i
     */
    @Override
    public void div() {
        double realPart = ((complexNumberCalculator.getNumber1().getReal() *
                ...
                (complexNumberCalculator.getNumber1().getImaginary() *
                        complexNumberCalculator.getNumber2().getImaginary())) /
                ((Math.pow(complexNumberCalculator.getNumber2().getReal(), 2) +
                        Math.pow(complexNumberCalculator.getNumber2().getImaginary(), 2)));
        double imaginaryPart = ((complexNumberCalculator.getNumber1().getImaginary() *
                complexNumberCalculator.getNumber2().getReal() -
